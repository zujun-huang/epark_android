...
import cn.epark.activities.OnlineNavigationActivity;
import cn.epark.activities.SafePaymentActivity;
import cn.epark.adapters.AdvertisementAdapter;
...
import cn.epark.view.ChildListView;
import cn.epark.view.MapFrameLayout;
...
public class MainFragment extends BaseFragment implements View.OnClickListener, SensorEventListener, OnGetSuggestionResultListener {
    ...
    private void updateParkInfo(PoiInfo poiInfo, boolean isClick) {
        ...
        ss.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.theme_color)),
