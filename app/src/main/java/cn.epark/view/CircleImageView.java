...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setRadius(a.getDimensionPixelSize(R.styleable.CircleImageView_civ_radius, -1));
        a.recycle();
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isRoundImage) {
            Bitmap b = getRoundBitmap(mBitmap, radiusPx);
    ...
    public void setImageUrl(String url){
        try {
            ...
            setImageBitmap(BitmapFactory.decodeStream(picUrl.openStream()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     *
     * @param bitmap
     * @param radiusPx 圆角边框大小，默认10px
     * @return
     */

    private Bitmap getRoundBitmap(Bitmap bitmap, int radiusPx) {
        ...
        canvas.drawRoundRect(rectF, radiusPx, radiusPx, mBitmapPaint);
    ...
    public boolean getBorderOverlay() {
